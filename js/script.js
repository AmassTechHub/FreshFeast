...
const menuData = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1523677011781-c91d1bbe5f2a?w=500',
    popular: false
  },
  {
    id: 13,
  ...
  cartItemsList.innerHTML = cart.map(item => `
    <div class="cart-page-item">
      ...
      <div class="cart-page-item-controls">
        ...
        <button class="cart-page-remove" onclick="removeFromCartPage(${item.id})" aria-label="Remove item">🗑️</button>
      </div>
    </div>
  `).join('');
